...
const BasicInfo = () => {
    return (
        <>
            <article className="col-md-12 bg-white border my-3 rounded-3 basci-info">
                    <div className="row"><h5 className="heading pt-3 ">Basic Information <span className="fa fa-home"></span> </h5></div>
                    <form className="px-4">
                    <div class="form-row">
                        <div class="col">
